...
const jobResponsibilities = {
  1: [
    "Develop and maintain UI components using React.js.",
...
export default function Overview() {
  return (
    <div className="flex-col sm:justify-center sm:items-center sm:w-3/4 w-full  ">
      <h3 className="text-lg font-bold tracking-[1.2px] pb-6 "> Description</h3>
      <p className="sm:text-lg font-[500] sm:tracking-[2px] sm:leading-9 text-aboutCont  font-mons">
        {description}
      </p>

      <h3 className="text-lg font-bold mt-4">Key Responsibilities</h3>
      ...
      <h3 className="text-lg font-bold mt-4">Requirements</h3>
      <ul className="list-disc pl-5">

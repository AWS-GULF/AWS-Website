      ...
      <div className="px-6 sm:px-0">
        <div className="  sm:ms-12 sm:me-12">
          ...
          <div className="flex justify-center items-center ">
            <h2 className="sm:text-5xl text-[20px] font-mons font-bold mb-[60px] sm:mb-[80px] text-center  sm:tracking-[4.8px] sm:leading-[75px] ">
          ...
          <div className="flex-col items-center text-center sm:text-start sm:flex   sm:flex-row  sm:justify-center sm:items-center sm:px-[121px] mb-16 gap-16  ">
            ...
            <div className="w-full sm:w-3/4 pt-14 flex-col sm:justify-center sm:items-center ps-1 mt-[-30px] ">
              ...
              <p className="font-mons text-[16px] font-normal text-[400] tracking-[1.6px] leading-[30px] ">
                Our development team is committed to providing realistic and
                precise timelines for project milestones. This approach ensures
                timely delivery without ever compromising the quality of the
                final product.
              </p>
            </div>
          ...
          <div className="flex-col items-center text-center sm:text-start sm:flex   sm:flex-row  sm:justify-center sm:items-center sm:px-[121px] mb-16 gap-16   ">
            ...
            <div className="w-full sm:w-3/4 pt-14 flex-col sm:justify-center sm:items-center ps-1 mt-[-30px] ">
              ...
              <p className="font-mons text-[16px] font-normal text-[400] tracking-[1.6px] leading-[30px]    ">
                ...
                developed highly effective testing and diagnostic strategies.
                These cover both functional and non-functional aspects of your
                product, ensuring a smooth development process and minimizing
          ...
          <div className="flex-col items-center text-center sm:text-start sm:flex   sm:flex-row  sm:justify-center sm:items-center sm:px-[121px] mb-16 gap-16  ">
            ...
            <div className="w-full sm:w-3/4 pt-14 flex-col sm:justify-center sm:items-center ps-1 mt-[-30px]">
              ...
              <p className="font-mons text-[16px] font-normal text-[400] tracking-[1.6px] leading-[30px]    ">
                For enterprise clients, we assign a dedicated professional from
                our pro-services team to manage your account exclusively
                throughout the entire development and delivery process. This
                ensures personalized support and seamless communication at every
                stage.
              </p>
            </div>

    ...
    <>
      <div className="px-6 sm:px-0">
        <div className="  sm:ms-12 sm:me-12">
          ...
          <div className="mb-12">
            <h2 className="text-primary font-mons text-[16px] sm:text-[28px] font-bold tracking-[.64px] pb-8">
              WHO WE ARE?
            </h2>
            <p className="text-aboutCont font-mons text-[10px] sm:text-[16px] mb-8 sm:mb-0 tracking-[1.4px] font-normal leading-[35px]">
              ...
              between cutting-edge technology and impactful marketing
              strategies, we specialize in delivering tailored solutions that
              empower businesses to thrive in today’s fast-paced digital
              landscape.
            </p>
          </div>
          {/* ////////////////////////////////////////////////////////////////////////////////////////////////////////////// */}
          ...
          <div className="  flex flex-wrap justify-between  sm:flex-nowrap sm:gap-4 mb-[100px] ">
            <div className=" flex-col ps-5 justify-evenly items-end sm:justify-center sm:items-center w-[45%] sm:w-1/3 mb-4 ">
              <span className=" sm:px-[80px] mb-4 px-[10px] py-6  bg-primary rounded-[10px] text-[#fff] font-mons text-[14px] sm:text-[20px] font-[500] ">
                OUR VISION
              </span>
              <p className="text-start mt-[30px] text-aboutCont font-mons text-[10px] sm:text-[14px] tracking-[1.12px] font-normal leading-[14px] sm:leading-[35px]">
            ...
            <div className="flex-col ps-5 justify-evenly items-end sm:justify-center sm:items-center w-[45%] sm:w-1/3 mb-4">
              <span className=" sm:px-[80px] px-[10px] py-6  bg-primary rounded-[10px] text-[#fff] font-mons text-[14px] sm:text-[20px] font-[500] ">
                OUR MESSAGE
              </span>
              <p className="text-start mt-[30px] text-aboutCont font-mons text-[10px] sm:text-[14px] tracking-[1.12px] font-normal leading-[14px] sm:leading-[35px]">
                We provide tailored solutions that align perfectly with your
                business needs. We are dedicated to sharing our expertise with
                our clients, and we take pride in collaborating across various
                industries to develop strategies that deliver impactful results.
                Our focus is on equipping our clients with the right resources
                to complement their technology, ensuring their success and
                growth.
              </p>
            </div>
            <div className="flex-col ps-5 justify-evenly items-end sm:justify-center sm:items-center w-[40%] sm:w-1/3 mt-4 sm:mt-0">
              ...
              <p className="text-start mt-[30px] text-aboutCont font-mons text-[10px] sm:text-[14px] tracking-[1.12px] font-normal leading-[14px] sm:leading-[35px]">
                ...
                advancements, especially in AI, we ensure a cutting-edge
                approach that maximizes return on investment for our business
                clients.
              </p>
            </div>
          </div>
          ...
          <div className="flex mb-[100px] gap-2 ">
            <div className="sm:w-[80%] w-[70%] flex-col justify-start sm:items-start items-center ">
              <p className="text-aboutCont font-mons text-[16px] sm:text-[32px] sm:tracking-[6.4px] font-bold leading-[24px] sm:leading-[60px] pb-[30px]">
          ...
          <MyModal />
            ...
            <div className="sm:w-1/2  w-[45%]  text-start items-start  ">
              <ul className="flex-col items-start justify-start space-y-2 sm:space-y-4">
          ...
          <div className="sm:flex-row sm:flex flex-col  sm:gap-4  sm:mb-[60px] ">
            <div className="sm:w-1/2 w-full mb-4">
              <p className="text-aboutCont font-mons text-[12px] sm:text-[18px] tracking-[1.4px] leading-[16px]  sm:leading-[35px] ">
                {" "}
                <span className="text-primary font-bold font-mons text-[14px] sm:text-[24px] tracking-[1.68px] leading-[16px]  sm:leading-[35px]">
                  Our team
                </span>{" "}
                ...
                dedicated to turning your vision into reality. With AMS GULF,
                you don’t just stay ahead of the curve – you set the pace for
                the future.
              </p>
            </div>
          ...
          <div className="sm:flex sm:flex-row flex-col mb-[100px] space-y-4 sm:space-y-0 sm:gap-4">
            <div className="card bg-base-100 sm:w-96 p-4 h-[500px] border border-[##E0E0E0">
              ...
              <div className=" items-center text-center">
                <h2 className="text-center text-primary font-mons font-[600] tracking-[1.6]">
                  Mostafa Karam
                </h2>
                <p>CMO</p>
              </div>
          ...
          <div className="flex justify-center items-center ">
            <h3 className="font-mons text-[16px] sm:text-[32px] font-bold tracking-[5.12px]">
              Our Leading Brands Partnerships
            </h3>
          </div>

          <div className="flex-col mt-[60px] ">
            <div className="flex  justify-between items-center overflow-auto scrollbar">
              <img src={nfaa} className="sm:h-[70px] h-[50px] sm:w-[190px] w-[120px]  pe-5 " alt="" />
              <img src={nfaa} alt="" className="sm:h-[70px] h-[50px] sm:w-[190px] w-[120px]  pe-5" />
              <img src={hwlk} alt="" className="sm:h-[70px] h-[50px] sm:w-[190px] w-[120px]  pe-5" />
              <img src={axis} alt="" className="sm:h-[70px] h-[50px] sm:w-[190px] w-[120px]  pe-5" />
              <img src={thmeen} alt="" className="sm:h-[70px] h-[50px] sm:w-[190px] w-[120px]  pe-5" />
            </div>
            <div className="flex  justify-between items-center mt-[80px] mb-[100px] overflow-auto scrollbar">
              <img src={value} className="sm:h-[70px] h-[50px] sm:w-[190px] w-[120px]  pe-5" alt="" />
              <img src={opm} alt="" className="sm:h-[70px] h-[50px] sm:w-[190px] w-[120px]  pe-5" />
              <img src={akark} alt="" className="sm:h-[70px] h-[50px] sm:w-[190px] w-[120px]  pe-5" />
              <img src={roag} alt="" className="sm:h-[70px] h-[50px] sm:w-[190px] w-[120px]  pe-5" />
              <img src={century} alt="" className="sm:h-[70px] h-[50px] sm:w-[190px] w-[120px]  pe-5" />
            </div>
          </div>
        </div>
      </div>

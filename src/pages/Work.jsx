  ...
  return (
    <div className="sm:ms-12 sm:me-12">
      ...
      <div className="flex justify-center items-center  ">
        <h2 className="sm:text-5xl text-[20px] font-mons font-bold mb-[10px] sm:mb-[20px] sm:px-[150px] text-center  sm:tracking-[4.8px] leading-[75px]  text-primary">
          BUILDING SUCCESS TOGETHER
        </h2>
      </div>

      <div className="flex justify-center items-center text-center px-[60px] pb-[70px] ">
        <p className="text-secondary font-mons text-[15px] sm:text-[20px] font-[400] leading-[30px] tracking-[0.4px]">
